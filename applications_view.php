...
<div id="wrapper">
	...
	<div id="topContent">
		<div class="container">
			...
			<div class="row">
				...
				<div class="span7">
					<div id="top" class="sectiontitle">View application</div>
				</div>
			</div>
		</div>
	</div>
	<div id="mainContent">
		<div class="container">
			<div class="row">
				<div class="span12">
					<strong>Welcome back, <? print($_SESSION["user"]["name"]); ?>!</strong> <a href="logout.php">Logout</a>
					<br><br><a href="admin.php">&laquo; Back to applications</a>
					<hr>
					<div id="applications">
